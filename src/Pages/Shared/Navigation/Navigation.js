...
const Navigation = () => {
    return (
        <Navbar expand="lg" style={{ backgroundColor: '#0C2340', boxShadow: '8px 8px 22px #9fa4b3, -8px -8px 22px' }}>
            <Container>
                <Navbar.Brand href="/" className='text-light'>Computer Club</Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        <NavDropdown title="Department" id="basic-nav-dropdown" className='text-light'>
                            <NavDropdown.Item href="#action/3.1">Department Info</NavDropdown.Item>
                            <NavDropdown.Item href="#action/3.2">Teachers</NavDropdown.Item>
                            <NavDropdown.Item href="#action/3.3">Executive member</NavDropdown.Item>
